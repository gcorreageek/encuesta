...
<!-- //			ea.getEncuestaprofesor().getUsuario().getApellidoPaterno() -->
<!-- //			ea.getEncuestaprofesor().getUsuario().getApellidoMaterno(); -->
<!-- //			ea.getEncuestaprofesor().getUsuario().getNombre(); -->
<!-- //			ea.getEncuestaprofesor().getEncuesta().getAnio().getCurso().getCurso() -->
<!-- //			ea.getInicioEncuesta(); -->
<!-- //			ea.getFinEncuesta(); -->
	            <p>Encuesta del Profesor ${ea.encuestaprofesor.usuario.apellidoPaterno} 
	            ${ea.encuestaprofesor.usuario.apellidoMaterno} ${ea.encuestaprofesor.usuario.nombre},
	            del curso de ${ea.encuestaprofesor.encuesta.anio.curso.curso}
	            </p>
	            <i>Inicio - Fin = ${ea.inicioEncuesta} - ${ea.finEncuesta}</i>
	            </div> 
	          </div>
 			</div>   
