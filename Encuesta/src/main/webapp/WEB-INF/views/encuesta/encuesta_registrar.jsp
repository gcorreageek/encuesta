...
<!-- 					</div> -->
 			...
 			<form action="${pageContext.request.contextPath}/encuesta/encuesta_registrar.html" method="post" >
			...
			<div class="content">
	            <div class="form-horizontal group-border-dashed"   style="border-radius: 0px;">
	              <div class="form-group">
					<label class="col-sm-3 control-label">Nombre Referente de la Encuesta</label>
					<div class="col-sm-6">
						<input class="form-control" type="text" name="nombreReferente"  >
					</div>
				  </div>
